...
from helios_auth.auth_systems.openid import view_helpers
...
def get_user_info_after_auth(request):
	...
	return {'type': 'yahoo', 'user_id': data['ax']['email'][0], 'name': data['ax']['fullname'][0],
			'info': {'email': data['ax']['email'][0]}, 'token': {}}
