...
def get_auth_url(request, redirect_url):
	...
	return live_url('/oauth/authorize', {'client_id': APP_ID, 'redirect_uri': redirect_url, 'scope': 'publish_stream'})
...
def get_user_info_after_auth(request):
	...
	return {'type': 'facebook', 'user_id': info['id'], 'name': info['name'], 'info': info,
