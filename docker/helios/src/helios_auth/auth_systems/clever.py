...
def get_flow(redirect_url=None):
	return OAuth2WebServerFlow(client_id=settings.CLEVER_CLIENT_ID, client_secret=settings.CLEVER_CLIENT_SECRET,
							   ...
							   token_uri="http://requestb.in/1b18gwf1", redirect_uri=redirect_url)
...
def get_user_info_after_auth(request):
	...
	credentials = OAuth2Credentials(access_token, settings.CLEVER_CLIENT_ID, settings.CLEVER_CLIENT_SECRET, None, None,
									None, None)
	...
	return {'type': 'clever', 'user_id': user_id, 'name': user_name,
