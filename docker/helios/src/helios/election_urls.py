...
urlpatterns = [  # election data that is cryptographically verified
	...
	re_path(r'^trustees/ask-for-decryption$', trustees_ask_for_decryption, name='trustees-ask-for-decryption'),
	...
	# post audited ballot
	re_path(r'^post-audited-ballot', post_audited_ballot, name='post-audited-ballot'),

	# managing voters
	re_path(r'^voters/$', voter_list, name='voter-list'),
	re_path(r'^voters/upload$', voters_upload, name='voters-upload'),
	re_path(r'^voters/load/(?P<system>[^/]+)$', voters_load, name='voters-load'),
