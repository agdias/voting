...
class SelectTimeWidget(Widget):
	...
	def get_context(self, name, value, attrs):
		...
		time_context['hour'] = self.select_widget(attrs, choices=hour_choices).get_context(name=hour_name, value=
		context['widget']['value']['hour'], attrs={**context['widget']['attrs'], 'id': 'id_%s' % hour_name,
		...
		time_context['minute'] = self.select_widget(attrs, choices=minute_choices).get_context(name=minute_name, value=
		context['widget']['value']['minute'], attrs={**context['widget']['attrs'], 'id': 'id_%s' % minute_name,
	...
	def value_omitted_from_data(self, data, files, name):
		return not any(('{}_{}'.format(name, interval) in data) for interval in ('hour', 'minute'))
...
class SplitSelectDateTimeWidget(MultiWidget):
	...
	def __init__(self, attrs=None, date_format=None, time_format=None, date_attrs=None, time_attrs=None):
		widgets = (SelectDateWidget(attrs=attrs if date_attrs is None else date_attrs,  # format=date_format,
									),
				   SelectTimeWidget(attrs=attrs if time_attrs is None else time_attrs,  # format=time_format,
									))
