...
from helios.crypto.pct_warnings import RandomPool_DeprecationWarning
...
class RandomPool(object):
	...
	def __init__(self, numbytes=160, cipher=None, hash=None, file=None):
		warnings.warn(
			"This application uses RandomPool, which is BROKEN in older releases.  See http://www.pycrypto.org/randpool-broken",
