...
class DiscreteLogProof(LDObject):
	...
	STRUCTURED_FIELDS = {'challenge': 'core/BigInteger', 'commitment': 'core/BigInteger', 'response': 'core/BigInteger'}
...
class PublicKey(LDObject):
	...
	FIELDS = ['y', 'p', 'g', 'q']
	STRUCTURED_FIELDS = {'y': 'core/BigInteger', 'p': 'core/BigInteger', 'g': 'core/BigInteger', 'q': 'core/BigInteger'}
...
class SecretKey(LDObject):
	...
	FIELDS = ['public_key', 'x']
	STRUCTURED_FIELDS = {'public_key': 'pkc/elgamal/PublicKey', 'x': 'core/BigInteger'}
