...
class Trustee(LDObject):
	...
	STRUCTURED_FIELDS = {'pok': 'pkc/elgamal/DiscreteLogProof', 'public_key': 'pkc/elgamal/PublicKey'}
...
class Election(LDObject):
	FIELDS = ['uuid', 'questions', 'name', 'short_name', 'description', 'voters_hash', 'openreg', 'frozen_at',
			  'public_key', 'cast_url', 'use_advanced_audit_features', 'use_voter_aliases', 'voting_starts_at',
			  'voting_ends_at']

	STRUCTURED_FIELDS = {'public_key': 'pkc/elgamal/PublicKey', 'voting_starts_at': 'core/Timestamp',
...
class EncryptedAnswer(LDObject):
	...
	STRUCTURED_FIELDS = {'choices': arrayOf('pkc/elgamal/EGCiphertext'),
						 'individual_proofs': arrayOf('pkc/elgamal/DisjunctiveProof'),
						 'overall_proof': 'pkc/elgamal/DisjunctiveProof', 'randomness': 'core/BigInteger'
